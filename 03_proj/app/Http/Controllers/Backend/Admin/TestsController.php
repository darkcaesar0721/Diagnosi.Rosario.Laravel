...
class TestsController extends Controller
{
    ...
    public function create()
    {
        ...
        $font_family = array('Arial', 'Comic Sans MS', 'Courier New', 'Georgia', 'Lucida Sans Unicode', 'Tahoma', 'Times New Roman', 'Trebuchet MS', 'Verdana');
        $font_size = array(8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 36, 48, 72);
        return view('backend.tests.create', compact('courses', 'lessons', 'font_family', 'font_size'));
    }
    ...
    public function edit($id)
    {
        ...
        $font_family = array('Arial', 'Comic Sans MS', 'Courier New', 'Georgia', 'Lucida Sans Unicode', 'Tahoma', 'Times New Roman', 'Trebuchet MS', 'Verdana');
        $font_size = array(8, 9, 10, 11, 12, 14, 16, 18, 20, 22, 24, 26, 28, 36, 48, 72);
        return view('backend.tests.edit', compact('test', 'courses', 'lessons', 'font_family', 'font_size'));
    }
