            ...
            <div class="row">
                    ...
                    <div class="col-8 p-0">
                        ...
                        @if($question->titlelocation == 'col-12 order-1')
                            @php
                                print_r(str_replace("<p>&nbsp;</p>", "", $question->question));
                                    @endphp
                        {!! html_entity_decode(str_replace("<p>&nbsp;</p>", "", $question->question)) !!}
                        <!-- <h2 class="d-inline-flex question-heading  w-100">
                            <span class="">{!! html_entity_decode(str_replace("<p>&nbsp;</p>", "", $question->question)) !!}</span>
                        <h2> -->
                        @endif
                    </div>
            ...
            <div class="row">
                    ...
                    @if($question->help_info != "")
                            <span data-toggle="modal" data-target="#exampleModalLong{{$question->id}}" style="" class="d-inline-block mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px" fill="currentColor" class="img-responsive bi bi-patch-question-fill" viewBox="0 0 16 16" style="margin-top: 5px; color: {{$lesson->color1}} !important">
...
{{--                            <img src="https://www.diagnosiaziendale.it/storage/logos/help.png" class="img-responsive" width="29px" height="35px">--}}
                        @endif
                        @include('frontend.components.questions.required')
                    </div>
                </div>
...
<div class="text-right">
    <div id="navigation-btns" class="mb-2" style="">
        <button type="button" id="pre-pg" class="btn btn-danger" style="background: {{$lesson->color1}} !important; border: 1px solid {{$lesson->color1}} !important;">Previous</button>
        <button type="button" id="next-pg" class="btn btn-danger" style="background: {{$lesson->color1}} !important; border: 1px solid {{$lesson->color1}} !important;">Next</button>
    </div>
    {{-- <div id="navigation-btns" class="mb-2" style="">
        <button type="submit" id="pre-pg" class="btn btn-danger">Answer</button>
    </div> --}}
    <div class="genius-btn mt60 gradient-bg ml-auto custom-btn" id="report_div" style="width: 90px; background: {{$lesson->color1}} !important">
        <a id="create-report" href="javascript:void(0);" class="" style="background: {{$lesson->color1}} !important;">Report</a>
    </div>
